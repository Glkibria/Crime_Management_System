	...
	<div class="footer-nav">
		...
		<div class="footer-nav__col footer-nav__col--info">
            ...
            <ul class="footer-nav__list">
              ...
              <li class="footer-nav__item">
                <a href="police_station.php" class="footer-nav__link">police station </a>
              </li>
              <li class="footer-nav__item">
                <a href="Serve.php" class="footer-nav__link">User service</a>
              </li>
              <li class="footer-nav__item">
          ...
          <div class="footer-nav__col footer-nav__col--account">
            ...
            <ul class="footer-nav__list">
              ...
              <li class="footer-nav__item">
                <a href="user_register.php" class="footer-nav__link">Register</a>
              </li>
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				<div class="email">
					Email:
					<a href="mailto:support@gmail.com" class="email__addr">support@gmail.com</a>
				</div>
			</div>
