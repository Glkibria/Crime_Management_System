...
<li class="<?php if(isset($_GET['my_complain'])){ echo "active"; } ?>">

<a href="my_account.php?my_complain"> <i class="fa fa-list"> </i> My Complain </a>

</li>

<li class="<?php if(isset($_GET['my_feedback'])){ echo "active"; } ?>">

<a href="my_account.php?my_feedback"> <i class="fa fa-list"> </i> My Feedback </a>

</li>
<li class="<?php if(isset($_GET['submit_complain'])){ echo "active"; } ?>">

<a href="my_account.php?submit_complain"> <i class="fa fa-trash-o"></i> Submit Complain </a>

</li>
<li class="<?php if(isset($_GET['submit_feedback'])){ echo "active"; } ?>">

<a href="my_account.php?submit_feedback"> <i class="fa fa-trash-o"></i> Submit Feedback </a>
