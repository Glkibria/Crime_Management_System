...
<div id="content"><!-- content Starts -->
  <div class="container"><!-- container Starts -->
    ...
    <div class="col-md-11"><!-- col-md-12 Starts -->
      ...
      <div class="box"><!-- box Starts -->
        ...
        <form action="user_register.php" method="post" enctype="multipart/form-data"><!-- form Starts -->
...
if (isset($_POST['register'])) {
  ...
  if ($result['success'] == 0) {
    ...
    $get_email = "select * from user where user_email='$c_email'";
...
<a href='localhost/criminal/user/my_account.php?$user_confirm_code'>
...
";
    ...
    $insert_user = "insert into user (user_name,user_email,user_pass,user_country,user_city,user_contact,user_address,user_image,user_ip,user_confirm_code) values ('$c_name','$c_email','$c_pass','$c_country','$c_city','$c_contact','$c_address','$c_image','$c_ip','$user_confirm_code')";
