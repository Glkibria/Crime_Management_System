...
$get_user = "select * from user  where user_email='$c_email'";
...
$from = "glkibria@gmail.com";

$message = "

<h2>
Email Confirmation By bdpolice.com $c_name
</h2>
...
if(isset($_GET['my_complain'])){

include("my_complain.php");

}

if(isset($_GET['my_feedback'])){

  include("my_feedback.php");
...
if(isset($_GET['submit_complain'])){

  include("submit_complain.php");
