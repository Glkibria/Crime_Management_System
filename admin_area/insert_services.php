...
$sel_service = "select * from services";

$run_service = mysqli_query($con,$sel_service);

$count = mysqli_num_rows($run_service);

if($count == 3){

echo "<script>alert('You Have already Inserted 3 service columns')</script>";
