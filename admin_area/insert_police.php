...
<div class="col-md-6">
  ...
  <select name="criminal_cat" class="form-control">
    ...
    while ($row_p_station = mysqli_fetch_array($run_p_station)) {
      ...
      $p_station_name = $row_p_station['station_title'];

      echo "<option value='$p_station_name' >$p_station_name</option>";
    }
...
$insert_police = "insert into police (police_name,police_station,police_email,police_pass,police_image,police_contact,police_country,police_job,police_about) values ('$police_name','$p_station_name','$police_email','$police_pass','$police_image','$police_contact','$police_country','$police_job','$police_about')";
