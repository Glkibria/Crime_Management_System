...
<a href="index.php?view_comp">
    ...
    <i class="fa fa-fw fa-list"></i> View complain

</a>
<a href="index.php?view_feed">

    <i class="fa fa-fw fa-list"></i> ViewFeedback
                ...
                <li><!-- service section li Starts -->

                    <a href="#" data-toggle="collapse" data-target="#service">

                        <i class="fa fa-fw fa-briefcase"></i> Police Services
                    ...
                    <ul id="service" class="collapse">
                        ...
                        <li>
                            <a href="index.php?insert_services"> Insert Police Services</a>
                        </li>

                        <li>
                            <a href="index.php?view_services"> View Police Services </a>
                        </li>

                    </ul>

                </li><!-- service section li Ends -->

                <li><!-- station section li Starts -->

                    <a href="#" data-toggle="collapse" data-target="#station">

                        <i class="fa fa-fw fa-briefcase"></i> Police Station

                        <i class="fa fa-fw fa-caret-down"></i>

                    </a>

                    <ul id="station" class="collapse">

                        <li>
                            <a href="index.php?insert_station"> Insert Police Station </a>
                        </li>

                        <li>
                            <a href="index.php?view_station"> View Police Station </a>
                        </li>

                    </ul>

                </li><!-- station section li Ends -->
                <li><!-- news section li Starts -->

                    <a href="#" data-toggle="collapse" data-target="#news">

                        <i class="fa fa-fw fa-briefcase"></i> News
                ...
                </li><!-- news section li Ends -->
                <li><!-- safety tips section li Starts -->

                    <a href="#" data-toggle="collapse" data-target="#tips">

                        <i class="fa fa-fw fa-briefcase"></i> Police Safety Tips
                    ...
                    <ul id="tips" class="collapse">
                        ...
                        <li>
                            <a href="index.php?insert_stips"> Insert Safety Tips </a>
                        </li>

                        <li>
                            <a href="index.php?view_stips"> View Safety Tips </a>
                        </li>

                    </ul>

                </li><!-- safety tips section li Ends -->
                ...
                <li><!-- li Starts -->
                    ...
                    <ul id="police" class="collapse">
                        ...
                        <li>
                            <a href="index.php?insert_police"> Insert police </a>
                        </li>
                        ...
                        <li>
                            <a href="index.php?police_profile=<?php  ?>"> Edit police Profile </a>
                        </li>
